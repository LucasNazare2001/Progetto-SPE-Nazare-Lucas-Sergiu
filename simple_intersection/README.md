...
```
chmod +x setup_and_run_wnds.sh
```

And then run
```
./setup_and_run_wnds.sh
```
...
Python and SUMO must be installed. Python dependencies are listed in `requirements.txt` and are installed automatically by the setup script.
